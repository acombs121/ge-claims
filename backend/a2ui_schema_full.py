                ...
                "properties": {
                  ...
                  "VegaChart": {
                    ...
                    "properties": {
                      "spec": {
                        "type": "object",
                        "description": "The Vega-Lite JSON specification defining the chart visualization directly entirely nested within this object."
                      }
                    },
                    "required": ["spec"]
                  },
                  "DataGrid": {
                    ...
                    "properties": {
                      "columns": {
                        "type": "array",
                        "description": "List of objects describing each column, e.g., {'field': 'id', 'headerName': 'ID'}",
                        "items": { "type": "object" }
                      },
                      "rows": {
                        "type": "array",
                        "description": "List of row data objects mapping to the columns, e.g., {'id': 1, 'name': 'Item A'}.",
                        "items": { "type": "object" }
                      }
                    },
                  ...
                  "WebFrame": {
                    ...
                    "properties": {
                      ...
                      "htmlContent": {
                        "type": "object",
                        "description": "Raw HTML content to render inside the frame as an alternative to URL.",
                        "properties": {
                          "literalString": { "type": "string" },
                          "path": { "type": "string" }
                        }
                      ...
                      "height": {
                        "type": "number",
                        "description": "Height constraint for the webframe (e.g., 500)."
                      }
                    }
                  }
                }
